...
int main()
{
    info("%s", zeno::smart::toSize(dump).c_str());
    info("%s", zeno::smart::toSize(k5).c_str());
    info("%s", zeno::smart::toSize(m7).c_str());
    info("%s", zeno::smart::toSize(g4).c_str());
    info("%s", zeno::smart::toSize(t2).c_str());

    info("%s", zeno::smart::toOps(dump_ops).c_str());
    info("%s", zeno::smart::toOps(k3_ops).c_str());
    info("%s", zeno::smart::toOps(m2_ops).c_str());
    info("%s", zeno::smart::toOps(g4_ops).c_str());
    info("%s", zeno::smart::toOps(t1_ops).c_str());

    info("%s", zeno::smart::nsToLatency(dump_ns).c_str());
    info("%s", zeno::smart::nsToLatency(us_8).c_str());
    info("%s", zeno::smart::nsToLatency(ms_142).c_str());
    info("%s", zeno::smart::nsToLatency(s_42).c_str());
    return 0;
}